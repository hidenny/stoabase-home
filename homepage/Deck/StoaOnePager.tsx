...
function StoaLogo({ size = 56 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280 56" fill="none" height={size}>
      ...
      {/* Top bar: x=4..48, center=26 */}
      <rect x="4" y="6" width="44" height="5" rx="2" fill="url(#p-g)" opacity="0.9" />
      {/* 3 pillars, width=6, gap=7 → total=32, side margin=6 → x=10,23,36 center=26 ✓ */}
      <rect x="10" y="13" width="6" height="30" rx="2" fill="url(#p-g)" />
      <rect x="23" y="13" width="6" height="30" rx="2" fill="url(#p-g)" opacity="0.75" />
      <rect x="36" y="13" width="6" height="30" rx="2" fill="url(#p-g)" opacity="0.55" />
      {/* Bottom bar: x=4..48 */}
      <rect x="4" y="45" width="44" height="5" rx="2" fill="url(#b-g)" />
      <circle cx="26" cy="28" r="2.5" fill="#c4b5fd" opacity="0.7">
        <animate attributeName="opacity" values="0.4;0.9;0.4" dur="3s" repeatCount="indefinite" />
      </circle>
      <text x="62" y="38" fontFamily="'Inter', sans-serif" fontSize="30" fontWeight="700" fill="#f1f5f9" letterSpacing="-0.5">
...
function StoaLogoBlack({ size = 56 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 56" fill="none" height={size}>
      {/* Top bar: x=4..48, center=26 */}
      <rect x="4" y="6" width="44" height="5" rx="2" fill="#1a1a1a" />
      {/* 3 pillars, width=6, gap=7 → total=32, side margin=6 → x=10,23,36 center=26 ✓ */}
      <rect x="10" y="13" width="6" height="30" rx="2" fill="#1a1a1a" />
      <rect x="23" y="13" width="6" height="30" rx="2" fill="#1a1a1a" />
      <rect x="36" y="13" width="6" height="30" rx="2" fill="#1a1a1a" />
      {/* Bottom bar: x=4..48 */}
      <rect x="4" y="45" width="44" height="5" rx="2" fill="#1a1a1a" />
      <text x="62" y="38" fontFamily="'Inter', sans-serif" fontSize="30" fontWeight="700" fill="#1a1a1a" letterSpacing="-0.5">
        StoaBase
      </text>
    </svg>
  );
